...
// קבוצות בתוך "היום"
 ...
 /* הסף ירד מ-16 ל-14 בהחלטה מפורשת, לא כדי לרצות בדיקה שנכשלה.
    16 נולד מצמצום הכרום — זכייה שלא נגעו בה: הכרום עדיין מצומצם,
    והבדיקות שמעל שומרות עליו. מה שירד הוא צפיפות השורה, במכוון:
    «שורות נושמות» הרים את גובה השורה מ-32px ל-39px ובנה שלוש רמות
    בתוכה. ארבע שורות שילמו על זה. אם הכרום יתנפח שוב, 14 ייפול. */
 ok('14+ שורות גלויות ב-1512x860',bud.vis>=14,bud.vis+' שורות (11 לפני צמצום הכרום · 18 לפני שורות נושמות)');
